# @claude-agent-ui/tailwind-preset

Optional default styling for `@claude-agent-ui/react`.
...
```tsx
import { conversationClass, userMessageClass } from "@claude-agent-ui/tailwind-preset";
